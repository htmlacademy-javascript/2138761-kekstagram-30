import {hashFocus,commentsFocus} from './part2.js';
...
function resetEffects() {
   ...
   // let hashFocus;let commentsFocus;
    ...
    if (e.key==='Escape'){if(hashFocus||commentsFocus){e.preventDefault()} else {
    ...
    let nonUiStyle = document.createElement('style');
    nonUiStyle.innerHTML =' #slider-fit { position: relative; top: 3px; padding: 0 16px;} #slider-fit .noUi-connect { background: #23af67;}';
    document.querySelectorAll('head')[0].appendChild(nonUiStyle);
    ...
    let  classToAdd=''; sliderStyleSelect (classToAdd); 
      sliderElement.style.display='none'; }))
